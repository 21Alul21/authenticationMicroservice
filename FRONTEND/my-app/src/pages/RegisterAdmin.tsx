    ...
    return (
        <>
            ...
            <div style={{ marginTop: "80px", padding: "20px", maxWidth: "400px", margin: "80px auto 0", backgroundColor: "#f9f9f9", borderRadius: "8px", boxShadow: "0 0 10px rgba(0,0,0,0.1)" }}>
                <h2 style={{ textAlign: "center", marginBottom: "20px" }}>Register as Admin</h2>
                <form onSubmit={handleSubmit}>
                    <div>
                    <label htmlFor="specialCode" style={{ display: "block", marginBottom: "5px" }}>Admin Special code:</label>
                        <input
                            type="text"
                            id="specialCode"
                            name="specialCode"
                    ...
                    <button 
                        ...
                        style={{ 
                            width: "100%", 
                            padding: "10px", 
                            backgroundColor: isLoading ? "#cccccc" : "#9e0721", 
                            color: "white", 
                            border: "none", 
                            borderRadius: "4px", 
